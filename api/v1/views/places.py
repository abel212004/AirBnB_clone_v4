#!/usr/bin/python3
"""
 Default API actions handler for Place objects' view.
"""
...
def places(city_id):
    """
     Return a list of places for a city
    """
...
def put_place(place_id):
    """
     Update a place. This is a PUT method
    """
    place = storage.get("Place", place_id)
    if not place:
        abort(404)
...
def places_search():
    """
     Search Places based on search parameters
    """
